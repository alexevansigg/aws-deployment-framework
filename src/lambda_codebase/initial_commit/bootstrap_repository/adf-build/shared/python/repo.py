    ...
    def create_update(self):
        ...
        if _repo_exists:
            ...
            if _stack_status == "ROLLBACK_COMPLETE":
                ...
                LOGGER.info(
                    """Stack %s in ROLLBACK_COMPLETE but the repository still 
                    exists, manual intervention maybe necessary""", 
                    self.stack_name
                )
                return
